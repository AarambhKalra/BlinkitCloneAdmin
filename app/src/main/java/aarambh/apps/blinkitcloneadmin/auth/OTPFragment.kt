...
import aarambh.apps.blinkitcloneadmin.databinding.FragmentOTPBinding
...
class OTPFragment : Fragment() {
    ...
    private fun verifyOTP(otp: String) {
        viewModel.signInWithPhoneAuthCredential(otp, adminNumber)
    ...
    private fun sendOTP() {
        ...
        viewModel.apply {
            sendOTP(adminNumber, requireActivity())
            lifecycleScope.launch {
                otpSent.collect {
                    if (it) {
                        Utils.hideDialog()
    ...
    private fun getUserNumber() {
        ...
        adminNumber = bundle?.getString("number").toString()

        binding.tvUserNumber.text = adminNumber
    }
